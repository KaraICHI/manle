...
public class CollectorMangerActivity extends Activity implements View.OnClickListener {
    private List<Collector.ResultBean> result;
            ...
            switch (id) {
                case 100:
                    ...
                    if (response != null) {
                        ...
                        adapter.setOnItemClickListener(new CollectorAdapter.OnItemClickListener() {
                            @Override
                            public void setOnItemClickListener(GoodsBean data) {
    ...
    private void processData(String json) {
        ...
        result = collector.getCollects();
        datas = new ArrayList<>();
        for (Collector.ResultBean temp:result) {
            GoodsBean goodsBean = new GoodsBean(temp.getName(),temp.getCover_price(),temp.getFigure(),temp.getProduct_id());
            datas.add(goodsBean);
